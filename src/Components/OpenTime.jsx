...
export const OpenTime = ()=> {
    return (
        <div className="opentime-container w-full h-[200px] bg-slate-700 rounded-xl mt-10 shadow-black shadow-md flex flex-col gap-4 justify-center items-center">
            <h2 className='font-bold text-4xl text-slate-200 '>We Are Open <span className='text-lime-300 font-bold italic'>EVERYDAY</span></h2>
            <h2 className='font-bold text-4xl text-slate-200 '>Time 6 AM - 11 PM</h2>
