      ...
      <ul className="flex min-w-[100px] justify-center gap-1 xl:min-w-[550px]">
        <li className="flex-col w-[40px] h-8 justify-center items-center xl:flex xl:w-[100px] xl:border-x-4 xl:border-lime-300">
          <NavLink to={"/"} activeClassName="active" className="">
            ...
            />
            <h3 className="invisible font-bold hover:text-xl hover:font-extrabold xl:visible">Home</h3>
          </NavLink>
        </li>
        <li className="flex-col w-[40px] h-8 justify-center items-center xl:flex xl:w-[100px] xl:border-r-4 xl:border-lime-300">
          <NavLink to={"/booking"} activeClassName="active" className="">
            <FontAwesomeIcon
              ...
              className="visible xl:hidden"
            />
            <h3 className="invisible font-bold hover:text-xl hover:font-extrabold xl:visible">Booking</h3>
          </NavLink>
        </li>
        <li className="flex-col w-[40px] h-8 justify-center items-center xl:flex xl:w-[100px] xl:border-r-4 xl:border-lime-300">
          ...
          <FontAwesomeIcon
              ...
              className="visible xl:hidden"
            />
            <h3 className="invisible font-bold hover:text-xl hover:font-extrabold xl:visible">Coach</h3>
          </NavLink>
        </li>
        <li className="flex-col w-[40px] h-8 justify-center items-center xl:flex xl:w-[100px] xl:border-r-4 xl:border-lime-300">
          ...
          <FontAwesomeIcon
              ...
              className="visible xl:hidden"
            />
            <h3 className="invisible font-bold hover:text-xl hover:font-extrabold xl:visible">About Us</h3>
          </NavLink>
        </li>
        <li className="flex-col w-[40px] h-8 justify-center items-center xl:flex xl:w-[100px] xl:border-r-4 xl:border-lime-300">
          ...
          <FontAwesomeIcon
              ...
              className="visible xl:hidden"
            />
            <h3 className="invisible font-bold hover:text-xl hover:font-extrabold xl:visible">Contact</h3>
          </NavLink>
        </li>
      </ul>
      ...
      {!idtoken ? (
        ...
        <ul className="flex w-[150px] justify-end items-center gap-3 xl:min-w-[300px]">
          ...
          <li className="flex items-center xl:items-start xl:min-w-[125px] xl:max-h-20 xl:flex-col">
            <NavLink to={"/profile"}>
              <h1 className="invisible w-0 xl:w-[150px] xl:max-h-8 xl:overflow-hidden xl:mb-1 xl:visible">{userFname} {userLname}</h1>
            </NavLink>
