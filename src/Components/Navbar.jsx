    ...
    return (
       <div className="navigation top-0 left-0 right-0 flex p-3 w-full text-white justify-between items-center">
            ...
            <ul className="nav-link  flex justify-center gap-5 ">
                <li><NavLink to={'/'} activeClassName='active'   className='hover:text-blue-900 hover:font-bold ' >Home</NavLink></li>
                ...
                {idtoken ? (
                    <li>
                        <button onClick={logout} className='w-20 rounded-full bg-white hover:bg-gray-100 text-blue-900 hover:text-blue-950 text-base'>
                            Log out
                        </button>
                    </li>
                ) : (
                    <li>
                        <NavLink to={'/login'} activeClassName='active' className='hover:text-white hover:font-bold'>
                            <button className='w-20 rounded-full bg-white hover:bg-gray-100 text-blue-900 hover:text-blue-950 text-base'>
                                Log in
                            </button>
                        </NavLink>
                    </li>
