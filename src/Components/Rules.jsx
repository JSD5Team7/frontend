        ...
        <section className="rules-container w-full bg-slate-700 h-fit p-3 mb-20 rounded-xl shadow-black shadow-md ">
            ...
            <div className="rule-item w-full p-5 flex gap-10">
                <div className="leftside w-2/4">
                    ...
                    <p className="indent-10 text-white text-justify">Bookings are confirmed upon receipt of payment or any other specified confirmation process.</p>
                    <h3 className="bg-lime-300 pt-1 pb-2 pl-3 pr-3 font-bold my-2 w-fit rounded-full">4. Cancellation Policy</h3>
                    <p className="indent-10 text-white text-justify">Players are required to cancel their booking within a specified time frame if they are unable to attend. Failure to do so may result in penalties or forfeiture of the booking fee.</p>
                    <h3 className="bg-lime-300 pt-1 pb-2 pl-3 pr-3 font-bold my-2 w-fit rounded-full">5. Booking Extensions</h3>
                    <p className="indent-10 text-white text-justify">Extensions to the allotted 1-hour time slot may be granted based on availability and adherence to club policies.</p>
                    <h3 className="bg-lime-300 pt-1 pb-2 pl-3 pr-3 font-bold my-2 w-fit rounded-full">6. Fair Usage Policy</h3>
                    <p className="indent-10 text-white text-justify">Players are encouraged to be mindful of others and use the facilities efficiently during their allotted time.</p>
                ...
                <div className="right-side w-2/4">
                    ...
                    <p className="indent-10 text-white text-justify">Bookings can be made within a defined time frame in advance, ensuring fair access for all members.</p>
                    ...
                    <p className="indent-10 text-white text-justify">Guests are welcome but must adhere to the same booking procedures and time limits as members.</p>
                    <h3 className="bg-lime-300 pt-1 pb-2 pl-3 pr-3 font-bold my-2 w-fit rounded-full">11. Rescheduling Policy</h3>
                    <p className="indent-10 text-white text-justify">Players may be allowed to reschedule their booking based on availability and adherence to club policies.</p>
                    <h3 className="bg-lime-300 pt-1 pb-2 pl-3 pr-3 font-bold my-2 w-fit rounded-full">12. Facility Maintenance</h3>
                    <p className="indent-10 text-white text-justify">The club reserves the right to schedule maintenance periods, during which certain facilities may be temporarily unavailable. Advance notice will be provided.</p>
                    <h3 className="bg-lime-300 pt-1 pb-2 pl-3 pr-3 font-bold my-2 w-fit rounded-full">13. Compliance with Club Rules</h3>
                    <p className="indent-10 text-white text-justify">All players must comply with the club's rules and regulations, including those related to time limits and booking procedures.</p>
