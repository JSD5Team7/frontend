    ...
    return(
        <Layout>
            <div className="terms-content m-10 p-10 text-lg leading-7 bg-slate-700 rounded-xl ">
                ...
                <p className='mt-3 pl-10 text-white text-justify'> Welcome to our sport club! By accessing and using our facilities for tennis, badminton, swimming, yoga, and aerobic dance, you agree to comply with and be bound by these Terms of Service. If you do not agree with any part of these terms, please do not use our services.</p>

                <h3 className='text-2xl text-lime-300 font-semibold mt-3'>2. Club Membership</h3>
                <p className='mt-3 pl-10 text-white text-justify'>- To access our facilities, you may be required to become a member of sport club. Membership details, including fees and benefits, can be found on our website or provided upon request.</p>
                <p className='mt-3 pl-10 text-white text-justify'>- Membership is open to individuals of all ages, subject to our membership criteria.</p>
                ...
                <p className='mt-3 pl-10 text-white text-justify'>- Participation in sports and physical activities carries inherent risks. Our Sport Club is not liable for any injuries, accidents, or damages that may occur on our premises.</p>
                ...
                <p className='mt-3 pl-10 text-white text-justify'>- Our Sport Club reserves the right to modify or update these Terms of Service at any time. Any changes will be effective upon posting on our website.</p>
                ...
                <p className='mt-3 pl-10 text-white text-justify'>By using our services, you acknowledge that you have read, understood, and agreed to these Terms of Service. Thank you for choosing Our Sport Club for your sporting and fitness needs. We look forward to providing you with a safe and enjoyable experience!</p>
            </div>
        </Layout>
    )
}
