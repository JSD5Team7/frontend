...
const ContactUs = () => {
    ...
    return(
        <Layout>
            <div className="contact-container mt-16 mb-20 p-10 w-full flex justify-center items-stretch">
                <div className="contact-content flex bg-blue-200 bg-opacity-10 backdrop-blur-md m-0 p-0 rounded-md shadow-md shadow-black">
