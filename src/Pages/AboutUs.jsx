    ...
    return(
        <Layout>
            ...
            {/* relative top-1 z-0 */}
                ...
                <h2 className='absolute text-brown-800 text-8xl italic font-extrabold opacity-70'>Good vibes, Good health</h2>
            </div>
            <div className="about-us w-full mt-6 mb-10 p-10 text-lg text-gray-800">
                ...
                <div className="img-first-section w-3/4 pl-6">
                    <img src="/src/assets/images/Yoga-Room-About-Us.jpeg" alt="tennis courts" style={{height:'350px'}}  className='w-full rounded-lg shadow-black shadow-md contrast-125 ' />
                </div>
                </div>
                ...
                <div className="img-first-section w-1/2 pr-6">
                    <img src="/src/assets/images/Table-Tennis-About-Us.jpeg" alt="tennis courts" style={{height:'350px'}} className='w-full rounded-lg shadow-black shadow-md contrast-125' />
                </div>
                </div>
                ...
                <div className="img-first-section w-1/2 p-6 ">
                    <img src="/src/assets/images/Tennis-Court-About-Us.jpeg" alt="tennis courts" style={{height:'450px'}} className='w-full rounded-lg shadow-black shadow-md contrast-125' />
                </div>
                </div>
