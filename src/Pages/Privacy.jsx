...
const Privacy = () => {
    return(
        <Layout>
            <div className="privacy-content m-10 p-10 text-lg leading-7 bg-white bg-opacity-30 rounded-xl ">
                <h2 className='text-center text-3xl font-bold mb-8'>Privacy Policy</h2>
                
                <h3 className='italic'>Effective Date: 20 SEP 2023</h3>
                ...
                <h3 className='font-bold text-emerald-700 mt-3'>1. Information We Collect</h3>
                <p className='mt-3 pl-10'>We may collect the following types of personal information from you:</p>
                ...
                <h3 className='font-bold text-emerald-700 mt-3'>2. How We Use Your Information</h3>
                ...
                <h3 className='font-bold text-emerald-700 mt-3'>3. Disclosure of Information</h3>
                ...
                <h3 className='font-bold text-emerald-700 mt-3'>4. Security Measures</h3>
                ...
                <h3 className='font-bold text-emerald-700 mt-3'>5. Your Rights and Choices</h3>
                <ul className='info list-disc pl-16'>
                ...
                <h3 className='font-bold text-emerald-700 mt-3'>6. Cookies and Tracking Technologies</h3>
                ...
                <h3 className='font-bold text-emerald-700 mt-3'>7. Changes to this Privacy Policy</h3>
                ...
                <h3 className='font-bold text-emerald-700 mt-3'>8. Contact Us</h3>
                ...
                <address className='pl-16 mt-5'>4 Privet Drive, Little Whinging,</address>
                <address className='pl-16'>Surrey, England</address>
                <a href="tel:+66812345678" className='pl-16 hover:text-emerald-700'>+66812345678</a><br/>
                <a href="mailto:sportclub@example.com" className='pl-16 hover:text-emerald-700'>sportclub@example.com</a>
